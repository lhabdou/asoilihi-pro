...
const ProjectsPage = {
  ...
  setup() {
    const projects = ref([
      ...
      { title: 'API Bancaire Sécurisée & Gestion de Comptes (BNP Paribas Cardif)', description: 'Architecture et implémentation d\'APIs hautement sécurisées pour les virements et la gestion de comptes. Mise en place d\'OAuth2, tests rigoureux avec JUnit et Postman, et documentation complète via Swagger. Travail sur la création et la gestion d\'applications de gestion des fonds.' },
      ...
      { title: 'Ingénieur Réalisateur (Java EE 1.8, Tomcat, PostgreSql) - Ministère de la transition écologique', description: '1ans 3mois: Projet du ministère de la transition écologique (IED : Industrial Emissions Directive), Outil permettant de constituer et de suivre les dossiers des éleveurs. ' },
